        ...
        <div className="border-t border-blue-500/20 p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              {status.days_remaining <= 2 && status.days_remaining > 0 && (
                <p className="text-orange-400 text-xs mt-1">Approaching 10-day exit</p>
              )}
            </div>
            ...
            <div>
              ...
              {status.distance_to_stop_loss_pct < 1.5 && (
                <p className="text-red-400 text-xs mt-1">Close to stop-loss</p>
              )}
            </div>
          ...
          {status.risks.length > 0 && (
            <div className="bg-neutral-900/50 rounded p-3">
              <p className="text-yellow-400 text-xs font-semibold mb-2">Active Risks:</p>
